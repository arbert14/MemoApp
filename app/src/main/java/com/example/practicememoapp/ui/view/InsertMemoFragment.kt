...
@AndroidEntryPoint
class InsertMemoFragment : Fragment(), MainActivity.OnBackPressedListener {
    private var _binding: FragmentInsertMemoBinding? = null
    private val binding: FragmentInsertMemoBinding
        get() = _binding!!
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = FragmentInsertMemoBinding.inflate(layoutInflater)
        binding.insertMemoFragment = this
    }
